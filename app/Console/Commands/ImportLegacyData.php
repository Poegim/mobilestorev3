...
class ImportLegacyData extends Command
{
    ...
    private function importItems(): void
    {
        $this->importChunked('Items', 'items', 'items', fn ($r) => [
            ...
            'status' => $r['status'],
            // Denormalized feature columns (previously skipped — this is why IMEI was empty)
            'feature_color_id' => $r['feature_color_id'],
            'feature_condition_id' => $r['feature_condition_id'],
            'feature_price' => $r['feature_price'],
            'feature_imei' => $r['feature_imei'],
            'feature_simlock_network_id' => $r['feature_simlock_network_id'],
            'feature_memory' => $r['feature_memory'],
            'feature_storage' => $r['feature_storage'],
            'feature_box' => $r['feature_box'],
            'feature_proof_of_purchase' => $r['feature_proof_of_purchase'],
            'feature_comment' => $r['feature_comment'],
            'feature_dual_sim' => $r['feature_dual_sim'] ?? 0,
